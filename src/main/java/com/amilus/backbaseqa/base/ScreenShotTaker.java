...
public class ScreenShotTaker {
    ...
    private static Logger log = Logger.getLogger(ScreenShotTaker.class.getName());
    ...
    public static String takeBase64Screenshot(String testClassName, String methodName) {
        ...
        try {
            ...
            log.severe("Error occured while taking a screenshot!!!");
            Listener.test.get().fail("Error occured while taking a screenshot!!!");
        }
